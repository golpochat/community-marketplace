...
export class SellerVerificationStatusService {
  ...
  async getStatus(userId: string): Promise<SellerVerificationStatus> {
    ...
    return {
      ...
      legalName: personalDetails.legalName || undefined,
      registeredCompanyName: personalDetails.registeredCompanyName || undefined,
      croNumber: personalDetails.croNumber || undefined,

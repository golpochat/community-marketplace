...
import type { CreateListingReviewInput } from '@community-marketplace/validation';
...
export class BuyerReviewsService {
  ...
  async create(userId: string, dto: CreateListingReviewInput): Promise<ReviewRecord> {

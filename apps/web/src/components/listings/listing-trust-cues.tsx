  ...
  if (compact) {
    return (
      <p className={cn('flex items-start gap-2 text-xs text-muted-foreground', className)}>
        ...
        <span>
          {COMMERCE_PUBLIC_COPY.trustCueCompact}.{' '}
  ...
  return (
    <div className={className}>
      <p className="mb-2 text-xs font-medium uppercase tracking-wide text-muted-foreground">
        {COMMERCE_PUBLIC_COPY.trustCueTitle}
      </p>
      <p className="mb-3 text-sm text-muted-foreground">{COMMERCE_PUBLIC_COPY.trustCueBody}</p>
